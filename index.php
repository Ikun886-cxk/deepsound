...
function getLicenseKey() {
    ...
    $array = str_split($randomString, 6);
    return implode('-', $array);
}
function check_($check) {
    return array('status' => 'SUCCESS', 'url' => urlencode(getBaseUrl()), 'code' => $check);
}
                            ...
                            <div class="req">
                                ...
                                <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="purshase_code" value="<?php echo (isset($_POST['purshase_code'])) ? trim($_POST['purshase_code']): getLicenseKey();?>">
                                            <span class="help-block">Use the auto generated purchase code or use you own code.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1"></div>
